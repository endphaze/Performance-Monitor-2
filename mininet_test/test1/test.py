...
def myNetwork():
    ...
    for h in clients + servers:
        ...
        net.addLink(h, s1, bw=10, delay='1ms', jitter="10ms", reorder="25%", mtu=1500)
    ...
    # ปิด TSO ให้ cpu ตัดแบ่งข้อมูล
    print("*** Turn off TSO on srv1 and srv2")
    srv1.cmd('ethtool -K srv1-eth0 tso off')
    srv2.cmd('ethtool -K srv2-eth0 tso off')
